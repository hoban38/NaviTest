 ...
 * @author Yaniv Inbar
 */
public class AsyncBatchInsertCalendarList extends CalendarListAsyncTask {

  private final List<Calendar> calendars;

  public AsyncBatchInsertCalendarList(MainActivity calendarSample, List<Calendar> calendars) {
