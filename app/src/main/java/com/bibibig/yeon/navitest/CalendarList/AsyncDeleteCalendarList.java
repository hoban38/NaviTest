 ...
 * @author Yaniv Inbar
 */
public class AsyncDeleteCalendarList extends CalendarListAsyncTask {

  private final String calendarId;

  public AsyncDeleteCalendarList(MainActivity calendarSample, CalendarInfo calendarInfo) {
